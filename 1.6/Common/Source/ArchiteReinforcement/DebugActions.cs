...
namespace ArchiteReinforcement
{
    class DebugActions
    {
        [DebugAction("Archite", "One of every artifact", allowedGameStates = AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("Archite", actionType = DebugActionType.ToolMapForPawns, allowedGameStates = AllowedGameStates.PlayingOnMap)]
